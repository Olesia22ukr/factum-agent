...
1. Якщо кандидатів більше 6 — обери до 6 найбільш релевантних до запиту
   користувача (за роком, ціною, пробігом), і виклич assess_car_risk
   ОКРЕМО для кожного з обраних. Якщо кандидатів 6 або менше — оціни ризик
   для всіх.
...
3. Сформуй відповідь у такій структурі:
   ...
   Якщо всього знайдено більше, ніж ти оцінив — вкажи це прямо,
   наприклад: "Всього знайдено 18 автомобілів, детально оцінено 6
   найбільш релевантних за вашим запитом."
