...
- Якщо користувач просить оцінити ризики знайдених автомобілів,
  виклич assess_car_risk ОКРЕМО для кожного знайденого автомобіля.
...
- Якщо потрібно рекомендувати найкращий автомобіль,
  спочатку оціни ризики всіх знайдених кандидатів.
